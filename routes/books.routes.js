...
const saveImageToLocal = require('../middlewares/saveImageToLocal');
const upload = multer();
...
router.post('/', auth, upload.single('image'), saveImageToLocal, checkInput.addBook, booksCtrl.addBook);
router.post('/:id/rating', checkInput.addRating, booksCtrl.addRating);
router.put('/:id', auth, upload.single('image'), saveImageToLocal, checkInput.updateBook, booksCtrl.updateBook);
